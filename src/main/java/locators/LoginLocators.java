...
public class LoginLocators {
    public static final By btnLoginMainMenu = By.xpath("//button[normalize-space(.)='Login' or .//span[normalize-space()='Login']] | //button[normalize-space(.)='Sign in with Idaman']");
